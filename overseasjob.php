...
<body>
    ...
    <div class="nav_jobs">
        <center>
        <ul class="nav_list">
            <button class="nav_p"><a href ="#"> Over seas jobs</a></button>
    ...
    <!---trending jobs part-->
    <h2><center>Over seas jobs</center></h2>
<div class=" main_align">
    <section class="home_trending">
        <?php $sql = "SELECT * FROM overseasjobs";
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["overseas_company"]?> </h3>
                <img src="<?php echo $row["overseas_img"]?>" ><br><br>

                <h4><?php echo $row["overseas_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["overseas_salary"]?>.00</p>
                <a href='commonoverseas.php?id=<?php echo $row["overseas_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='commonoverseas.php?id=<?php echo $row["overseas_ID"]?> '><button>Apply</button></a>
            </div>
