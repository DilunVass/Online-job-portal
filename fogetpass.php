...
<body>
    <header class="header_s">
        <div class="h_row">
            ...
            <div class="h_col">
                <ul>
                    <div class="h_buttons">
                        <button><a href="sign_up_page.html">Sign up </a></button>
                    </div>
                </ul>
            </div>
        </div>
    ...
    <div class="nav_main">
        <ul>
            ...
            <button class="nav_points"><a class="a" href ="sign_up_page.html"> Contact Us</a></button>
        ...
        <div class="login_main">
            ...
            <form method="post" action="resetpass.php">
                ...
                <select name="type">
                    ...
                    <option name="jobintroducer">jobintroducer</option>
