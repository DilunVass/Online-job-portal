...
<body>
    ...
    <div class="nav_jobs">
        ...
        <ul class="nav_list">
            ...
            <button class="nav_p"><a href ="#"> Online jobs </a></button>
    ...
    <!---trending jobs part-->
    <h2><center>Online jobs</center></h2>
<div class=" main_align">
    <section class="home_trending">
        <?php $sql = "SELECT * FROM onlinejobs";
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["online_company"]?> </h3>
                <img src="<?php echo $row["online_img"]?>" ><br><br>

                <h4><?php echo $row["online_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["online_salary"]?>.00</p>
                <a href='commononline.php?id=<?php echo $row["online_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='commononline.php?id=<?php echo $row["online_ID"]?> '><button>Apply</button></a>
            </div>
