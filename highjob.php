...
<body>
    ...
    <div class="nav_jobs">
        ...
        <ul class="nav_list">
            ...
            <button class="nav_p"><a href ="#"> Highest paying </a></button>
    ...
    <!---trending jobs part-->
    <h2><center>Highest Paying jobs</center></h2>
<div class=" main_align">
    <section class="home_trending">
        <?php $sql = "SELECT * FROM highestjobs";
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["high_company"]?> </h3>
                <img src="<?php echo $row["high_img"]?>" ><br><br>

                <h4><?php echo $row["high_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["high_salary"]?>.00</p>
                <a href='commonhigh.php?id=<?php echo $row["high_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='commonhigh.php?id=<?php echo $row["high_ID"]?> '><button>Apply</button></a>
            </div>
