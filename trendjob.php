...
<body>
    ...
    <div class="nav_jobs">
        ...
        <ul class="nav_list">
            ...
            <button class="nav_p"><a href ="#"> Trending jobs </a></button>
    ...
    <section class="home_trending">
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["trend_company"]?> </h3>
                <img src="<?php echo $row["trend_img"]?>" ><br><br>

                <h4><?php echo $row["trend_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["trend_salary"]?>.00</p>
                <a href='commontrend.php?id=<?php echo $row["trend_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='commontrend.php?id=<?php echo $row["trend_ID"]?> '><button>Apply</button></a>
            </div>
