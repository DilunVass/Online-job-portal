...
<body>
    ...
    <div class="nav_jobs">
        ...
        <ul class="nav_list">
            ...
            <button class="nav_p"><a href ="#"> Part time jobs </a></button>
        </ul>
        </center>
    </div>
    ...
    <!---trending jobs part-->
    <h2><center>Parttime jobs</center></h2>
<div class=" main_align">
    <section class="home_trending">
        <?php $sql = "SELECT * FROM parttimejobs";
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["part_company"]?> </h3>
                <img src="<?php echo $row["part_img"]?>" ><br><br>

                <h4><?php echo $row["part_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["part_salary"]?>.00</p>
                <a href='commonpart.php?id=<?php echo $row["part_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='commonpart.php?id=<?php echo $row["part_ID"]?> '><button>Apply</button></a>
            </div>
