...
<body>
    ...
    <div class="nav_jobs">
        ...
        <ul class="nav_list">
            ...
            <button class="nav_p"><a href ="#"> Top Jobs </a></button>    
    ...
    <!---trending jobs part-->
    <h2><center>Top jobs</center></h2>
<div class=" main_align">
    <section class="home_trending">
        <?php $sql = "SELECT * FROM topjobs";
        ...
        ?>
            ...
            <div class="home_trending_card">
                <h3> <?php echo $row["top_company"]?> </h3>
                <img src="<?php echo $row["top_img"]?>" ><br><br>

                <h4><?php echo $row["top_title"]?></h4>
                <h5>Top job</h5>
                <p>Rs <?php echo $row["top_salary"]?>.00</p>
                <a href='common.php?id=<?php echo $row["top_ID"]?> '>See more details</a>
                <br><br><br>
                <a href='common.php?id=<?php echo $row["top_ID"]?> '><button>Apply</button></a>
            </div>
